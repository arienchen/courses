...
* `2025-02   ` 個人電腦稽核程式實作(系統指令腳本及Python稽核程式)
* `2025-03   ` 稽核數位轉型－Python數據分析入門  
* `2025-05   ` 稽核數位轉型－本地大型語言模型實作

### 課程紀錄
* `2024-05-30` [金融研訓院/數位稽核實務班/內部稽核數位分析 4H](./內部稽核數位分析/) [(第1期)📌](https://www.tabf.org.tw/CourseDetail.aspx?PID=564834)
