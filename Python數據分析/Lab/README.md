...
---
## LAB-03 Python Keyword<a id='lab-03'></a> [:paperclip:](./lab-03.ipynb)
...
* Jupyter 基本操作
  ...
  + 儲存為 PDF
--- 
## LAB-04 字串 str<a id='lab-04'></a> [:paperclip:](./lab-04.ipynb)
* 字串基本操作
* 大小寫轉換
* 去空白及填入
* 字串搜尋與比對
...
---
## LAB-05 格式化字串 f-string , format()<a id='lab-05'></a> [:paperclip:](./lab-05.ipynb)
* 基本語法
* 運算及函式調用
* 格式化數值
* 對齊與填充
...
---
## LAB-06 數值型別<a id='lab-06'></a> [:paperclip:](./lab-06.ipynb)
* 整數 `int` 
* 浮點數 `float` 
* 複數 `complex`
* 布林值 `bool` 
...
---
## LAB-07 序列型別 range, tuple, list<a id='lab-07'></a> [:paperclip:](./lab-07.ipynb)
...
---
## LAB-08 集合 set<a id='lab-08'></a> [:paperclip:](./lab-08.ipynb)
...
* 迴圈 `for-in` 
---
## LAB-09 字典 dict<a id='lab-09'></a> [:paperclip:](./lab-09.ipynb)
...
* 迭代(迴圈之使用) `for-in`
  ...
  + values
---
## LAB-10 條件判斷 if-elif-else<a id='lab-10'></a> [:paperclip:](./lab-10.ipynb)
...
```
---
## LAB-11 迴圈 for, while, break, continue<a id='lab-11'></a> [:paperclip:](./lab-11.ipynb)
* `for` 迴圈： 搭配序列，如：`list`, `tuple`, `range` 或 `set`, `dict`
* `while` 迴圈： 執行至到條件符合 `False` 或 `break`
* `break` 中斷： 退出整個迴圈
* `continue` 繼續： 跳過當前程式區塊，直接進入下一次迴圈
---
## LAB-12 函式 def<a id='lab-12'></a> [:paperclip:](./lab-12.ipynb)
...
* 函式作為參數
---
## LAB-13 模組 import, from, as<a id='lab-13'></a> [:paperclip:](./lab-13.ipynb)
...
* 給模組或函式取別名
---
## LAB-14 2024立法委員選舉資料<a id='lab-14'></a> [:paperclip:](./lab-14.ipynb)
* 瀏覽網頁取得 API、URL及查詢參數
* 透過系統內建工具 `curl` 下載檔案
* 以 `tqdm` 顯示下載檔案進程
* `f-string` 應用
...
---
## LAB-15 2024 總統選舉資料<a id='lab-15'></a> [:paperclip:](./lab-15.ipynb)
* 同 LAB-14 
* 帶入不同 **electionCode**
---
## LAB-16 Python 下載網頁<a id='lab-16'></a> [:paperclip:](./lab-16.ipynb)
...
---
## LAB-17 使用 Pandas 合併 CSV<a id='lab-17'></a> [:paperclip:](./lab-17.ipynb)
...
使用 AI 產出交易測試資料   
[Claude AI 生成結果](https://claude.ai/share/56c5df98-8018-4069-9488-19cdb2f6e600) [:paperclip:](./lab-18-01.ipynb) 
[ChatGPT 生成結果](https://chatgpt.com/share/67d3ae88-af20-8009-962a-522bf6aff7d3) [:paperclip:](./lab-18-02.ipynb) 
[Gemini 生成結果](https://g.co/gemini/share/98c8f58be3a6) [:paperclip:](./lab-18-03.ipynb)
...
```
---
## LAB-19 資料集檢視及清理<a id='lab-19'></a> [:paperclip:](./lab-19.ipynb)
...
* 另存 CSV 或 Excel
---
## LAB-20 班佛定律 Benford's Law<a id='lab-20'></a> [:paperclip:](./lab-20.ipynb)
...
---
## LAB-21 直方圖及熱度圖<a id='lab-21'></a> [:paperclip:](./lab-21.ipynb)
* 資料為 LAB-18 產生之測試資料
* `matplotlib` 中文字型設定
* 統計及檢視數值分布
* 直方圖
...
---
## LAB-22 2024 立法委員選舉結果<a id='lab-22'></a> [:paperclip:](./lab-22.ipynb)
...
---
## LAB-23 DataFrame Merge & Drill Down <a id='lab-23'></a> [:paperclip:](./lab-23.ipynb)
...
## LAB-24 Open Data 第三方支付公司登記資料 <a id='lab-24'></a> [:paperclip:](./lab-24.ipynb)
...
---
## LAB-25 抽樣 <a id='lab-25'></a> [:paperclip:](./lab-25.ipynb)
